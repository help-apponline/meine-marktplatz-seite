...
Weitere Informationen zu den eingesetzten technischen Dienstleistern findest du unter Punkt 11 „Empfänger personenbezogener Daten und Auftragsverarbeiter" dieser Datenschutzerklärung.` },
...
Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO (Erfüllung gesetzlicher Verpflichtungen) sowie Art. 6 Abs. 1 lit. f DSGVO aufgrund unseres berechtigten Interesses an der Gewährleistung einer sicheren, vertrauenswürdigen und rechtskonformen Plattform.` },
    { h: "11. Empfänger personenbezogener Daten und Auftragsverarbeiter", p: `Zur Bereitstellung und dem Betrieb von help-app.online arbeiten wir mit externen Dienstleistern zusammen, die personenbezogene Daten ausschließlich in unserem Auftrag oder im Rahmen der gesetzlichen Bestimmungen verarbeiten.
...
Die jeweils eingesetzten Dienstleister können sich im Zuge der technischen Weiterentwicklung unserer Plattform ändern. Diese Datenschutzerklärung wird in diesem Fall entsprechend aktualisiert.` },
    { h: "12. Weitergabe von Daten zwischen Nutzern", p: `help-app.online dient der Vermittlung zwischen Auftraggebern und Helfern. Damit die Nutzung der Plattform möglich ist, werden bestimmte personenbezogene Daten anderen Nutzern angezeigt oder im Rahmen der Kommunikation zugänglich gemacht.
...
Sollten künftig kostenpflichtige Funktionen eingeführt werden, durch die ein Austausch von Kontaktdaten oder weitere Kommunikationsmöglichkeiten erst nach Abschluss einer kostenpflichtigen Buchung oder Freischaltung ermöglicht werden, wird die Datenverarbeitung entsprechend dieser Datenschutzerklärung sowie den jeweils gültigen Nutzungsbedingungen durchgeführt.` },
    { h: "13. Zahlungsabwicklung", p: `Für die Buchung kostenpflichtiger Leistungen, insbesondere Premium-Mitgliedschaften, Werbepartner-Abonnements oder sonstiger kostenpflichtiger Angebote, erfolgt die Zahlungsabwicklung über externe Zahlungsdienstleister.
...
Sollten künftig weitere Zahlungsdienstleister eingesetzt werden, wird diese Datenschutzerklärung entsprechend ergänzt oder aktualisiert.` },
    { h: "14. Widerrufsrecht für Verbraucher", p: `16.1 Widerrufsrecht
...
Trotz aller technischen und organisatorischen Sicherheitsmaßnahmen kann die Datenübertragung im Internet Sicherheitslücken aufweisen. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist daher nicht in jedem Fall möglich.` },
    { h: "16. Rechte der betroffenen Personen", p: `Soweit wir personenbezogene Daten von dir verarbeiten, stehen dir nach den Bestimmungen der Datenschutz-Grundverordnung (DSGVO) folgende Rechte zu:
...
Wir werden dein Anliegen entsprechend den gesetzlichen Vorgaben prüfen und bearbeiten.` },
    { h: "17. Speicherdauer", p: `Wir speichern personenbezogene Daten nur so lange, wie dies zur Erfüllung der in dieser Datenschutzerklärung genannten Zwecke erforderlich ist oder gesetzliche Aufbewahrungs- und Nachweispflichten bestehen.

Die Speicherdauer richtet sich insbesondere nach:

- der Dauer des Nutzungsverhältnisses,
- gesetzlichen Aufbewahrungsfristen,
- steuer- und handelsrechtlichen Vorschriften,
- der Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen.

Wird ein Nutzerkonto gelöscht oder die Löschung personenbezogener Daten verlangt, werden die betreffenden personenbezogenen Daten grundsätzlich gelöscht oder anonymisiert, sofern keine gesetzlichen Aufbewahrungspflichten oder sonstigen berechtigten Gründe einer Löschung entgegenstehen.
